...
public interface ContractFormInfoTemplateContract {
	...
	//视频广告改编合同 交付数量关联表
	String CONTRACT_MTADAPTATIONCONTRACT2 = "MtlAdaptationContract2";
	//视频广告拍摄制作合同 广告完成形式关联表
	String CONTRACT_MTLSHOOTINGANDPRODUCTIONCONTRACT1 = "MtlShootingAndProductionContract1";
	//视频广告拍摄制作合同 交付数量关联表
	String CONTRACT_MTLSHOOTINGANDPRODUCTIONCONTRACT2 = "MtlShootingAndProductionContract2";
	//视频广告拍摄制作合同 知识产权权利确认书(模板)
	String CONTRACT_MTLSHOOTINGANDPRODUCTIONCONTRACT3 = "MtlShootingAndProductionContract3";
	//*生产项目外包服务合同(关联表1）
	String CONTRACT_PRODUCTOUTSERVICECONTRACT1 = "ProductOutServiceContract1";
	//*生产项目外包服务合同(关联表2）
	String CONTRACT_PRODUCTOUTSERVICECONTRACT2 = "ProductOutServiceContract2";
	//*生产项目外包服务合同(关联表3)
	...
	//消防设施维修保养服务合同(关联表1)
	String CONTRACT_CONTRACTWBHT1="ContractWbht1";
	//买卖合同（国内设备购买）(关联表1)
