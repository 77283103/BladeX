 ...
 * @date : 2020-12-11 08:36:14
 */
@Getter
@Setter
@TableName("mtl_adaptation_contract1")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "MtlAdaptationContract1对象", description = "媒体类：视频广告改编合同关联表")
public class MtlAdaptationContract1Entity extends BaseEntity {
