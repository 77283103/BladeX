...
@Getter
@Setter
@TableName("mtl_audio_production_contract1")
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "MtlAudioProductionContract1对象", description = "媒体类：音频制作合同关联表")
public class MtlAudioProductionContract1Entity extends BaseEntity {
